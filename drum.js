...
//With Animation
   function playSound(buttonKey){
    switch (buttonKey.toUpperCase()) {
            case "W":
                var audio = new Audio("drum1.mp3.mp3");
                 audio.play();
                 break;
            case "A":
                var audio = new Audio("drum2.mp3.mp3");
                audio.play();
                break;
            case "S":
                var audio = new Audio("drum3.mp3.mp3");
                audio.play();
                break;
            case "D":
                var audio = new Audio("drum4.mp3.mp3");
                audio.play();
                break;
             case "J":
                var audio = new Audio("drum5.mp3.mp3");
                audio.play();
                break;
            case "K":
                var audio = new Audio("drum6.mp3.mp3");
                audio.play();
                break;
             case "L":
                var audio = new Audio("drum7.mp3.mp3");
                audio.play();
                break;
        }
    } 
